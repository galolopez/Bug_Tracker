...
namespace Bug_Tracker.Controllers
{
    public class TicketCommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,Comment,UserId,Created")] TicketComment ticketComments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,Comment,UserId,Created")] TicketComment ticketComments)
        {
            if (ModelState.IsValid)
            {
